# Mecánica de spawn de oasis — Documento de negocio

> Audiencia: stakeholders, product owner, usuario final avanzado.
> Sin jerga técnica. Para el detalle de implementación ver `documentacion/backend/referencia-funciones/oasis-spawn-composition.md`.
