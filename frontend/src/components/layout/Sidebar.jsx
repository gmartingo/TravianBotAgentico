...
// ni mundo activo), por eso es accesible desde el sidebar global.
// Recursos/Tropas/Construcción dependen de un mundo concreto → viven dentro
// del Espacio del mundo, no aquí.
const NAV_ITEMS = [
  {
    key: 'accounts',
    to: '/cuentas',
